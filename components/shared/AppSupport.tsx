import { SearchInput } from "@/app/support/components/support/SearchInput";
...
export const AppSupportWidget: React.FC<SupportWidgetProps> = ({
  className = "",
}) => {
  ...
  return (
    <section
      className={`max-w-[432px] z-30 text-base font-medium text-center leading-[1.2] ${className}`}
